...
class ChargeClass(object):
    ...
    headers = {
        ...
        'postman-token': "a0abfa24-6adf-ff08-74f7-d7a451f9b482"
    }
    def __init__(self):
...
if __name__=="__main__":
    print json.dumps(ChargeClass().couponCmbcothersend).decode('unicode-escape')