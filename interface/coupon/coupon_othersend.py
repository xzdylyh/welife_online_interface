...
class ChargeClass(object):
    ...
    headers = {
        ...
        'postman-token': "50090af3-aae4-df01-c566-1ff6e8f54d6a"
    }
...
if __name__=="__main__":
    print json.dumps(ChargeClass().couponOthersend).decode('unicode-escape')